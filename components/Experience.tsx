    ...
    <section id="experience" className="py-28 max-w-5xl mx-auto px-6">
      <div ref={ref} className="fade-up">
        ...
        <div className="flex items-baseline gap-4 mb-16">
          <span className="text-[11px] text-gray-300 tracking-widest uppercase">04</span>
          <h2
              ...
              <div key={index} className="pl-8 relative">
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-1 mb-1">
                    <h3 className="text-[15px] font-medium text-gray-900 group-hover:text-gray-600 transition-colors">
                      {exp.title}
                    </h3>
                    <span className="text-[12px] text-gray-400 shrink-0">{exp.period}</span>
                  </div>
